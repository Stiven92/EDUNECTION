				...
				<div class="row">		
					<div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
						<div class="single_blog">
							...
							<div class="content_box">
								<span>May 10, 2024 | <a href="blog_single.php">Education</a></span>
								<h2><a href="blog_single.php">Professional Mobile Painting and Sculpting</a></h2>
								<a class="btn_one" href="course.php">Read More <i class="ti-arrow-top-right"></i></a>
							</div>
						</div>
					</div><!-- END COL-->				
					<div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
						<div class="single_blog">
							...
							<div class="content_box">
								<span>May 16, 2024 | <a href="blog_single.php">Education</a></span>
								<h2><a href="blog_single.php">Professional Ceramic Moulding for Beginner</a></h2>
								<a class="btn_one" href="course.php">Read More <i class="ti-arrow-top-right"></i></a>							
							</div>
						</div>
					</div><!-- END COL-->
					<div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s" data-wow-offset="0">
						<div class="single_blog">
							...
							<div class="content_box">
								<span>May 18, 2024 | <a href="blog_single.php">Programing</a></span>
								<h2><a href="blog_single.php">Education Is About Create Leaders For Tomorrow </a></h2>
								<a class="btn_one" href="course.php">Read More <i class="ti-arrow-top-right"></i></a>
							</div>
						</div>
					</div><!-- END COL-->	
