				...
				<div class="col-lg-5 col-sm-12 col-xs-12">
					...
					<div class="sidebar-post">
						...
						<div class="single_popular">
							<a href="single_blog.php"><img src="../assets/img/blog/blog-1.png" alt="" /></a>
							<h5><a href="single_blog.php">Supercharging Your SEO Game with AI Writing Assistants</a></h5>
						</div><!-- END SINGLE POPULAR POST -->
						<div class="single_popular">
							<a href="single_blog.php"><img src="../assets/img/blog/blog-2.png" alt="" /></a>
							<h5><a href="single_blog.php">AI Writing Assistants and the Future of Content Marketing</a></h5>
						</div><!-- END SINGLE POPULAR POST -->
						<div class="single_popular">
							<a href="single_blog.php"><img src="../assets/img/blog/blog-3.png" alt="" /></a>
							<h5><a href="single_blog.php">Enhancing Your E-commerce Store With AI Writing Assistants.</a></h5>
						</div><!-- END SINGLE POPULAR POST -->
						<div class="single_popular">
							<a href="single_blog.php"><img src="../assets/img/blog/blog-4.png" alt="" /></a>
							<h5><a href="single_blog.php">Building your content strategy cannot get easier than this.</a></h5>
						</div><!-- END SINGLE POPULAR POST -->
						<div class="single_popular">
							<a href="single_blog.php"><img src="../assets/img/blog/blog-5.png" alt="" /></a>
							<h5><a href="single_blog.php">This is the only read you would need before sitting down to prepare</a></h5>
						</div><!-- END SINGLE POPULAR POST -->	
				...
				<div class="row">						
					...
					<div class="col-lg-2 col-sm-6 col-xs-12">
						<div class="single_footer">
							...
							<a href="index.php"><img src="../assets/img/google-play.jpg" class="foot_img" alt=""></a>  
							<a href="index.php"><img src="../assets/img/app-store.jpg" class="foot_img" alt=""></a>  
						</div>
					</div><!--- END COL -->	
				</div><!--- END ROW -->					
			</div><!--- END CONTAINER -->
